...
function cf7ra__show_from_data($post)
{
    ...
    $num_of_bathrooms = get_post_meta($post->ID, 'cf7ra_field_mappings_num_of_bathrooms', true);
    ...
    $first_name = get_post_meta($post->ID, 'cf7ra_field_mappings_custom_first_name', true);
    $last_name = get_post_meta($post->ID, 'cf7ra_field_mappings_custom_last_name', true);
    $seller_street_address = get_post_meta($post->ID, 'cf7ra_field_mappings_custom_seller_street_address', true);
    $seller_street_address1 = get_post_meta($post->ID, 'cf7ra_field_mappings_custom_seller_street_address1', true);
    $seller_zip = get_post_meta($post->ID, 'cf7ra_field_mappings_custom_seller_zip',  true);
    $seller_city = get_post_meta($post->ID, 'cf7ra_field_mappings_custom_seller_city', true);
    $seller_state = get_post_meta($post->ID, 'cf7ra_field_mappings_custom_seller_state', true);
    $seller_primary_phone = get_post_meta($post->ID, 'cf7ra_field_mappings_custom_seller_primary_phone', true);
    $seller_sec_phone = get_post_meta($post->ID, 'cf7ra_field_mappings_custom_seller_sec_phone',  true);
    $seller_company_url = get_post_meta($post->ID, 'cf7ra_field_mappings_custom_seller_company_url', true);
    $seller_calling_time = get_post_meta($post->ID, 'cf7ra_field_mappings_custom_seller_calling_time', true);
    $email_seller = get_post_meta($post->ID, 'cf7ra_field_mappings_custom_email_seller',  true);
    $seller_retrype_email = get_post_meta($post->ID, 'cf7ra_field_mappings_custom_seller_retrype_email', true);
    $seller_is_realtor = get_post_meta($post->ID, 'cf7ra_field_mappings_custom_seller_is_realtor',  true);
    $account_password = get_post_meta($post->ID, 'cf7ra_field_mappings_custom_account_password', true);
    $account_verify_password = get_post_meta($post->ID, 'cf7ra_field_mappings_custom_account_verify_password', true);
    $listing_sale_type = get_post_meta($post->ID, 'cf7ra_field_mappings_custom_listing_sale_type',  true);
    $irrigated = get_post_meta($post->ID, 'cf7ra_field_mappings_custom_irrigated', true);
    ...
    $manure_storage = get_post_meta($post->ID, 'cf7ra_field_mappings_manure_storage', true);
    $housing_name = get_post_meta($post->ID, 'cf7ra_field_mappings_housing_name', true);
    $housing_name = explode(',', $housing_name);
    $milk_facility = get_post_meta($post->ID, 'cf7ra_field_mappings_milk_facility', true);
